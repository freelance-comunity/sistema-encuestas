    ...
    <div class="row">
        <div class="col-md-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    {!! Form::model($student, [ 'method' => 'PATCH', 'url' => ['school/student', $student->id], 'class' => 'form-horizontal'
                    ]) !!}
                    ...
                    <div class="form-group {{ $errors->has('shift') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            {!! Form::select('shift',['Matutino'=>'Matutino', 'Vespertino'=>'Vespertino', 'Mixto'=>'Mixto', 'Otro'=>'Otro'], null, ['class'
                            => 'form-control']) !!} {!! $errors->first('shift', '
                            <p class="help-block">:message</p>') !!}
                        </div>
                    </div>
