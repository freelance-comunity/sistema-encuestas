@extends('layouts.blank') @section('title') Create new Post @stop @section('main_container')
<!-- page content -->
<div class="right_col" role="main">
    <h1>Create New Post</h1>
    <hr/> {!! Form::open(['url' => 'admin/posts', 'class' => 'form-horizontal']) !!}
    ...
    <div class="form-group">
        <div class="col-sm-offset-3 col-sm-3">
            {!! Form::submit('Create', ['class' => 'btn btn-primary btn-lg form-control']) !!}
        </div>
    </div>
