        ...
        <div class="col-md-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    {!! Form::model($poll, [ 'method' => 'PATCH', 'url' => ['poll/poll', $poll->id], 'class' => 'form-horizontal' ]) !!}
                    ...
                    <div class="form-group {{ $errors->has('type') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            {!! Form::select('type', ['SERVICIOS'=>'SERVICIOS', 'DOCENTE'=>'DOCENTE'],null, ['class' => 'form-control', 'required' =>
                            'required']) !!} {!! $errors->first('type', '
                            <p class="help-block">:message</p>') !!}
                        </div>
                    </div>
