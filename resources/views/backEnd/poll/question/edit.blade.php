    ...
    {!! Form::model($question, [
        ...
        'class' => 'form-horizontal'
            ...
            <div class="form-group {{ $errors->has('number_of_elements') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::number('number_of_elements', null, ['class' => 'form-control', 'required' => 'required']) !!}
                    {!! $errors->first('number_of_elements', '<p class="help-block">:message</p>') !!}
                </div>
            </div>
            <div class="form-group {{ $errors->has('poll_id') ? 'has-error' : ''}}">
                {!! Form::label('poll_id', 'Poll Id: ', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
                    {!! Form::number('poll_id', null, ['class' => 'form-control']) !!}
                    {!! $errors->first('poll_id', '<p class="help-block">:message</p>') !!}
                </div>
            </div>
