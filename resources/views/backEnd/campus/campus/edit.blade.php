    ...
    <div class="row">
        <div class="col-md-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    {!! Form::model($campus, [ 'method' => 'PATCH', 'url' => ['campus/campus', $campus->id], 'class' => 'form-horizontal' ])
                    !!}
                    ...
                    <div class="form-group {{ $errors->has('corporate_name') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            {!! Form::text('corporate_name', null, ['class' => 'form-control col-md-7 col-xs-12', 'required' => 'required']) !!} {!!
                    ...
                    <div class="form-group {{ $errors->has('federal_entity') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            {!! Form::text('federal_entity', null, ['class' => 'form-control col-md-7 col-xs-12', 'required' => 'required']) !!} {!!
                            $errors->first('federal_entity', '
                            <p class="help-block">:message</p>') !!}
                        </div>
                    </div>
